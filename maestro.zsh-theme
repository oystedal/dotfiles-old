...
PROMPT=$'%{\e[0;35m%}%B┌─[%b%{\e[0m%}%{\e[1;32m%}%n%{\e[1;30m%}@%{\e[0m%}%{\e[0;36m%}%m%{\e[0;35m%}%B]%b%{\e[0m%}%b%{\e[0;35m%}%B[%b%{\e[1;37m%}%~%{\e[0;35m%}%B]%b%{\e[0m%}%{\e[0;35m%}%b%{\e[0m%}$(mygit)$(hg_prompt_info)%{\e[0m%}%b 
%{\e[0;35m%}%B└─%{\e[0m%}%b '
# \e[0m%}
